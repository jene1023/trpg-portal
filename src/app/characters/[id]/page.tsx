...
export default async function CharacterDetailPage({ params }: Props) {
  ...
  const sectionClass = "rounded-lg border border-coc-border coc-card-bg coc-corner-frame p-4 space-y-4 transition-[border-color,box-shadow] duration-300 hover:border-coc-border-glow hover:shadow-[0_2px_18px_rgba(201,133,58,0.10),inset_0_1px_0_rgba(201,133,58,0.07)]";
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 coc-tool-grid">
              ...
              <Link
                href={`/characters/${id}/ccfolia-export`}
                className="flex items-center justify-between rounded-lg border border-coc-border bg-coc-surface px-3.5 py-2.5 text-sm text-coc-muted hover:text-coc-text hover:border-coc-border-glow transition-colors motion-safe:active:scale-[0.98]"
              >
                <span>CCFOLIAコマ出力</span>
                <span className="text-coc-gold">→</span>
              </Link>
              <Link
                href={`/characters/${id}/udonarium-piece`}
                className="flex items-center justify-between rounded-lg border border-coc-border bg-coc-surface px-3.5 py-2.5 text-sm text-coc-muted hover:text-coc-text hover:border-coc-border-glow transition-colors motion-safe:active:scale-[0.98]"
              >
                <span>コマ出力（ユドナリウム）</span>
                <span className="text-coc-gold">→</span>
              </Link>
              <Link
              ...
              <Link
                href={`/characters/${id}/portrait-prompt`}
                className="flex items-center justify-between rounded-lg border border-coc-border bg-coc-surface px-3.5 py-2.5 text-sm text-coc-muted hover:text-coc-text hover:border-coc-border-glow transition-colors motion-safe:active:scale-[0.98]"
              >
                <span>肖像画プロンプト（AI生成用）</span>
                <span className="text-coc-gold">→</span>
              </Link>
              <Link
              ...
              <Link
                href={`/characters/${id}/stats-history`}
                className="flex items-center justify-between rounded-lg border border-coc-border bg-coc-surface px-3.5 py-2.5 text-sm text-coc-muted hover:text-coc-text hover:border-coc-border-glow transition-colors motion-safe:active:scale-[0.98]"
              >
                <span>📈 成長グラフ</span>
                <span className="text-coc-gold">→</span>
              ...
              <Link
                href={`/characters/${id}/stat-history`}
                className="flex items-center justify-between rounded-lg border border-coc-border bg-coc-surface px-3.5 py-2.5 text-sm text-coc-muted hover:text-coc-text hover:border-coc-border-glow transition-colors motion-safe:active:scale-[0.98]"
              >
                <span>能力値推移グラフ</span>
                <span className="text-coc-gold">→</span>
              ...
              <Link
                href={`/characters/${id}/monthly-report`}
                className="flex items-center justify-between rounded-lg border border-coc-border bg-coc-surface px-3.5 py-2.5 text-sm text-coc-muted hover:text-coc-text hover:border-coc-border-glow transition-colors motion-safe:active:scale-[0.98]"
              >
                <span>月次レポート</span>
                <span className="text-coc-gold">→</span>
              ...
              <Link
                href={`/characters/${id}/san-analysis`}
                className="flex items-center justify-between rounded-lg border border-coc-border bg-coc-surface px-3.5 py-2.5 text-sm text-coc-muted hover:text-coc-text hover:border-coc-border-glow transition-colors motion-safe:active:scale-[0.98]"
              >
                <span>SAN分析</span>
                <span className="text-coc-gold">→</span>
              ...
              <Link
                href={`/characters/${id}/skill-import`}
                className="flex items-center justify-between rounded-lg border border-coc-border bg-coc-surface px-3.5 py-2.5 text-sm text-coc-muted hover:text-coc-text hover:border-coc-border-glow transition-colors motion-safe:active:scale-[0.98]"
              >
                <span>技能を一括入力</span>
                <span className="text-coc-gold">→</span>
              ...
              <Link
                href={`/characters/${id}/snapshot-compare`}
                className="flex items-center justify-between rounded-lg border border-coc-border bg-coc-surface px-3.5 py-2.5 text-sm text-coc-muted hover:text-coc-text hover:border-coc-border-glow transition-colors motion-safe:active:scale-[0.98]"
              >
                <span>スナップショット比較</span>
                <span className="text-coc-gold">→</span>
              </Link>
              <Link
                href={`/characters/${id}/clues`}
                className="flex items-center justify-between rounded-lg border border-coc-border bg-coc-surface px-3.5 py-2.5 text-sm text-coc-muted hover:text-coc-text hover:border-coc-border-glow transition-colors motion-safe:active:scale-[0.98]"
              >
                <span>手がかりボード</span>
                <span className="text-coc-gold">→</span>
              ...
              <Link
                href={`/characters/${id}/mysteries`}
                className="flex items-center justify-between rounded-lg border border-coc-border bg-coc-surface px-3.5 py-2.5 text-sm text-coc-muted hover:text-coc-text hover:border-coc-border-glow transition-colors motion-safe:active:scale-[0.98]"
              >
                <span>謎リスト（未解決疑問）</span>
                <span className="text-coc-gold">→</span>
              </Link>
              <Link
                href={`/characters/${id}/vows`}
                className="flex items-center justify-between rounded-lg border border-coc-border bg-coc-surface px-3.5 py-2.5 text-sm text-coc-muted hover:text-coc-text hover:border-coc-border-glow transition-colors motion-safe:active:scale-[0.98]"
              >
                <span>誓約・目標</span>
                <span className="text-coc-gold">→</span>
              ...
              <Link
                href={`/characters/${id}/skill-probs`}
                className="flex items-center justify-between rounded-lg border border-coc-border bg-coc-surface px-3.5 py-2.5 text-sm text-coc-muted hover:text-coc-text hover:border-coc-border-glow transition-colors motion-safe:active:scale-[0.98]"
              >
                <span>確率チャート（技能成功率）</span>
                <span className="text-coc-gold">→</span>
              </Link>
              <Link
                href={`/characters/${id}/skill-radar`}
                className="flex items-center justify-between rounded-lg border border-coc-border bg-coc-surface px-3.5 py-2.5 text-sm text-coc-muted hover:text-coc-text hover:border-coc-border-glow transition-colors motion-safe:active:scale-[0.98]"
              >
                <span>スキルレーダー</span>
                <span className="text-coc-gold">→</span>
              ...
              <Link
                href={`/characters/${id}/career-report`}
                className="flex items-center justify-between rounded-lg border border-coc-border bg-coc-surface px-3.5 py-2.5 text-sm text-coc-muted hover:text-coc-text hover:border-coc-border-glow transition-colors motion-safe:active:scale-[0.98]"
              >
                <span>活躍レポート</span>
                <span className="text-coc-gold">→</span>
